				...
				<article className="mx-auto flex max-w-3xl flex-col">
					<header className="mb-12 sm:mb-16">
						...
						<p className="mt-4 max-w-xl text-muted-foreground leading-7">
							Use Honeyicons in React with named imports, typed props, and
							colors that follow your interface.
						</p>
					</header>
					...
					<section aria-labelledby="customization" className="mt-16 sm:mt-20">
						...
						<dl className="mt-6 grid gap-x-10 gap-y-6 text-sm leading-6 sm:grid-cols-2">
							...
							<div>
								...
								<dd className="mt-1 text-muted-foreground">
									Icons inherit currentColor. Use a text color class or the
									color prop to match your theme.
								</dd>
							</div>
							<div>
							...
							<div>
								...
								<dd className="mt-1 text-muted-foreground">
									Icons are decorative by default. Add a title to label an
									image, or an aria-label to an icon-only button.
								</dd>
							</div>
						</dl>
					</section>
					<section aria-labelledby="catalog" className="mt-12 sm:mt-16">
						...
						<p className="mt-2 text-muted-foreground leading-7">
							Search the catalog by name or keyword, choose a category, and
							click an icon to copy its React snippet. Linear is the default
							style; available variants are listed in the catalog.
						</p>
						<div className="mt-6 flex flex-wrap gap-3">
							<Button nativeButton={false} render={<Link href="/icons" />}>
								Explore icons
							</Button>
							<Button
								variant="outline"
